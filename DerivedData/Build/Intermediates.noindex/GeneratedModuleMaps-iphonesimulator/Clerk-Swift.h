...
#ifndef CLERK_SWIFT_H
#define CLERK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Clerk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///
/// \endcode
SWIFT_CLASS("_TtC5Clerk21SignInWithAppleHelper")
@interface SignInWithAppleHelper : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class ASAuthorizationController;
@interface SignInWithAppleHelper (SWIFT_EXTENSION(Clerk)) <ASAuthorizationControllerPresentationContextProviding>
...
@interface SignInWithAppleHelper (SWIFT_EXTENSION(Clerk)) <ASAuthorizationControllerDelegate>
